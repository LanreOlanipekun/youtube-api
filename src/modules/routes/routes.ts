...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { VideoController } from './../../api/controllers/video/index';
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/api/video/:id',
            ...
            ...(fetchMiddlewares<RequestHandler>(VideoController.prototype.getVideoById)),
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/video/comments/:videoId',
            ...(fetchMiddlewares<RequestHandler>(VideoController)),
            ...(fetchMiddlewares<RequestHandler>(VideoController.prototype.getVideoComments)),

            function VideoController_getVideoComments(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getVideoComments.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, 200, next);
            } catch (err) {
                return next(err);
            }
